...
(*
 *ALCUNE NOTE UTILI:
 *Il terzo esercizio è collegato alla scorsa esercitazione, si consiglia di leggere la scorsa esercitazione
 ...
 *Ipotizziate che il 1 gennaio del 2000 fosse l'inizio di un ciclo lunare
 *(ci fosse quindi la Luna Nuova e il giorno corrispondente del ciclo lunare fosse 0).
 *
